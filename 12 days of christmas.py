...
#list of all gifts
listGifts = ["And a Partridge in a pear tree", "Two turtle doves", "Three french hens", "Four calling birds",
             "Five golden rings", "Six geese a-laying", "Sevens swans a-swimming", "Eight maids a-milking",
             "Nine ladies dancing", "Ten lords a-learing", "Eleven pipers piping", "Twelve Drummers Drumming"]
